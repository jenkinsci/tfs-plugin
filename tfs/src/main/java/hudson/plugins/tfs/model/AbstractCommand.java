...
public abstract class AbstractCommand {
     ...
     *
     * @param project an {@link Job to operate on}
     ...
     */
    public abstract JSONObject perform(final Job project, final StaplerRequest request, final JSONObject requestPayload, final ObjectMapper mapper, final TeamBuildPayload teamBuildPayload, final TimeDuration delay);
